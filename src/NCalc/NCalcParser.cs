...
public class NCalcParser : Parser 
{
    ...
    {   
        var retval = new NCalcParser.ncalcExpression_return {Start = input.LT(1)};
...
//        CommonTree EOF2_tree = null;
    ...
    {   
        var retval = new NCalcParser.logicalExpression_return {Start = input.LT(1)};
                    ...
                    case 1 :
                        // C:\\Users\\s.ros\\Documents\\Développement\\NCalc\\Grammar\\NCalc.g:82:59: '?' middle= conditionalExpression ':' right= conditionalExpression
                        {
                            char_literal3=(IToken)Match(input,19,FOLLOW_19_in_logicalExpression84); 
                                CommonTree char_literal3_tree = (CommonTree)adaptor.Create(char_literal3);
                            ...
                            char_literal4=(IToken)Match(input,20,FOLLOW_20_in_logicalExpression90); 
                                CommonTree char_literal4_tree = (CommonTree)adaptor.Create(char_literal4);
    ...
    {   
        var retval = new NCalcParser.conditionalExpression_return();
...
//        CommonTree set5_tree = null;
                        ...
                        case 1 :
                            // C:\\Users\\s.ros\\Documents\\Développement\\NCalc\\Grammar\\NCalc.g:90:4: ( '||' | 'or' ) right= conditionalExpression
                            {
                                ...
                                else 
                                {
                                 ...
                                 const BinaryExpressionType type = BinaryExpressionType.Or; 
    ...
    {   
        var retval = new NCalcParser.booleanAndExpression_return();
        retval.Start = input.LT(1);
...
//        CommonTree set6_tree=null;
    ...
    {   
        var retval = new NCalcParser.bitwiseOrExpression_return();
        retval.Start = input.LT(1);
    ...
    {   
        var retval = new NCalcParser.bitwiseXOrExpression_return {Start = input.LT(1)};
    ...
    {   
        var retval = new NCalcParser.bitwiseAndExpression_return {Start = input.LT(1)};
    ...
    {   
        var retval = new NCalcParser.equalityExpression_return();
        retval.Start = input.LT(1);
