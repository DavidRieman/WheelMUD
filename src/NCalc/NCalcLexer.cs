...
public class NCalcLexer : Lexer 
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="NCalcLexer"/> class.
    /// </summary>
        ...
        // C:\\Users\\s.ros\\Documents\\Développement\\NCalc\\Grammar\\NCalc.g:282:4: '\\\\' ( 'n' | 'r' | 't' | '\\'' | '\\\\' | UnicodeEscape )
        {
            ...
            switch ( input.LA(1) ) 
            {
                ...
                case 'u':
                    ...
                    break;
                default:
                    var nvae_d13s0 = new NoViableAltException("", 13, 0, input);
                    throw nvae_d13s0;
            }
    ...
    const string DFA7_eotS = "\x04\uffff";
    const string DFA7_eofS = "\x04\uffff";
    const string DFA7_minS = "\x02\x2e\x02\uffff";
    const string DFA7_maxS = "\x01\x39\x01\x65\x02\uffff";
    const string DFA7_acceptS = "\x02\uffff\x01\x01\x01\x02";
    const string DFA7_specialS = "\x04\uffff}>";
    ...
    const string DFA14_specialS = "\x43\uffff}>";
