...
namespace WheelMUD.Core
{
    ...
    /// </summary>
    /// <remarks>
    /// @@@ TODO: Provide searchability of registered Things through LINQ rather than, 
    ...
    public class ThingManager : ManagerSystem
    {
        ...
        /// </summary>
        private static readonly Lazy<ThingManager> instance = new Lazy<ThingManager>(() => new ThingManager());

        /// <summary>
        /// The dictionary of all managed Things.
        /// </summary>
        ...
        /// <summary>
        /// Prevents a default instance of the ThingManager class from being created.
        /// </summary>
        ...
        /// <summary>
        /// Gets the singleton ThingManager instance.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether a Thing is currently spawned in the world given the item id.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether any Things match the specified condition.
        /// </summary>
        ...
        /// <summary>
        /// Counts the number of Things matching the specified condition.
        /// </summary>
        /// <param name="condition">The condition.</param>
        ...
        /// <summary>
        /// Finds a thing using a name or part name.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves a collection of things matching the specified condition.
        /// </summary>
        /// <param name="condition">The condition.</param>
        ...
        /// <summary>
        /// Tries to retrieve a Thing matching the specified condition.
        /// </summary>
        /// <param name="condition">The condition.</param>
        ...
        /// <summary>
        /// Calls <see cref="DestroyThing"/> on all things matching the specified condition.
        /// </summary>
        /// <param name="condition">The condition.</param>
        ...
        /// <summary>
        /// Starts this system's individual components.
        /// </summary>
        ...
        /// <summary>
        /// Stops this system's individual components.
        /// </summary>
        ...
        /// <summary>
        /// Add or update the ThingManager's cache of Things; should be called when the ID of a Thing is established or changes.
        /// </summary>
