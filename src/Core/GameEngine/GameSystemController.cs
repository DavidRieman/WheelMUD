...
namespace WheelMUD.Core
{
    ...
    public class GameSystemController : ISystem, IRecomposable
    {
        ...
        /// <summary>
        /// Prevents a default instance of the GameSystemController class from being created.
        /// This is a private controller, because it is using the singleton pattern to instantiate a copy.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a list of rules associated with the current gaming system;
        /// a generic store for rules that don't fit into a specific category.
        /// </summary>
        [ImportMany]
        ...
        /// <summary>
        /// Recompose the GameSystemController with the latest components available.
        /// </summary>
        public void Recompose()
        {
            // Recompose the private Imported properties, then prepare a new usable list of each
            // game element, and replace the public list with a new one.  NOTE: we do not modify
            // the existing public lists at any time because they may be being iterated by other
            // threads.
        ...
        /// <summary>
        /// Exports an instance of the GameSystemController to MEF.
        /// </summary>
        [ExportSystem]
