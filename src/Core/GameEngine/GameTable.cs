...
namespace WheelMUD.Core
{
    ...
    {
        /// <summary>
        /// The delegates that will be used to deal with in-system game tables.
        /// </summary>
        private HybridDictionary gameTableDelegates;

        /// <summary>
        /// Initializes a new instance of the GameTable class.
        /// </summary>
        public GameTable()
        {
