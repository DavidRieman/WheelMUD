//-----------------------------------------------------------------------------
// <copyright file="ExportPerceivedThingRendererAttribute.cs" company="WheelMUD Development Team">
...
namespace WheelMUD.Core.Renderer
{
    ...
    public class ExportPerceivedThingRendererAttribute : ExportAttribute, IExportWithPriority
    {
        ...
        /// <remarks></remarks>
        public ExportPerceivedThingRendererAttribute(int rendererPriority)
            : base(typeof(RendererDefinitions.PerceivedThing))
        {
        ...
        public ExportPerceivedThingRendererAttribute(IDictionary<string, object> metadata)
        {
