...
namespace WheelMUD.Interfaces
{
    ...
    {
        /// <summary>
        /// An 'action received' event handler.
        /// </summary>
        event ActionReceivedEventHandler ActionReceived;

        /// <summary>
        /// Gets the living behavior of the Thing attached to this session.
        /// </summary>
        LivingBehavior LivingBehavior { get; }

        /// <summary>
        /// Gets the base Thing (player or whatnot) attached to this session.
        /// </summary>
        Thing Thing { get; }

        /// <summary>
        /// Gets the last action input that the session received.
        /// </summary>
        ActionInput LastActionInput { get; }

        /// <summary>
        /// Write data to the users screen
        /// </summary>
