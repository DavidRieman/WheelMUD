...
namespace WheelMUD.Core
{
    ...
    /// <summary>
    /// Base implementation of the Behavior class
    /// </summary>
    public abstract class Behavior : IPersistsWithPlayer
    {
        ...
        /// <summary>
        /// Gets or sets the ID for this behavior instance.
        /// </summary>
        public long ID { get; set; }

        /// <summary>
        /// Gets or sets the parent of this behavior instance.
        /// </summary>
        [JsonIgnore]
        ...
        /// <summary>
        /// Abstract placeholder for the clone method
        /// </summary>
