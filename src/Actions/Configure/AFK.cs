...
namespace WheelMUD.Actions
{
    ...
    /// <summary>
    /// Sets your status as afk to other players.  Optional reason can be specified (eg. AFK Back in 5).
    /// Added a length limiter on the afk reason to ensure it doesn't gum out anything displaying the message.
    /// </summary>
    [ExportGameAction]
